...
* This branch https://github.com/T-o-b-i-a-s/AndroidAPS/tree/3.2.0.4-ai3.0.2-noVersionCheck uses
  AndroidAPS 3.2.0.4 (which was the `master` version on the official [Nightscout AndroidAPS]
  (https://github.com/nightscout/AndroidAPS)
  repo before 3.3 was released) as a base and adds autoISF 3.0.2 to it.

## What's new in AutoISF Version 3.0.2-noVersionCheck when compared to 3.0
...
* If it is not already selected, switch to the branch you want to build by clicking on the branch name,
  ...
  the branch with an "origin/" prefix: e.g. `origin/3.2.0.4-ai3.0.2-noVersionCheck`. Left-click that name and
