...
enum class DoubleKey(
    ...
    ApsAutoIsfBgAccelWeight("bgAccel_ISF_weight", 0.0, 0.0, 2.0, defaultedBySM = true),
    ...
    ApsAutoIsfSmbDeliveryRatio("openapsama_smb_delivery_ratio", 0.2, 0.2, 1.0, defaultedBySM = true),
    ApsAutoIsfSmbDeliveryRatioMin("openapsama_smb_delivery_ratio_min", 0.5, 0.2, 1.0, defaultedBySM = true),
